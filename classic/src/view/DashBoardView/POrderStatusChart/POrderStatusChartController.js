Ext.define(
    "GSmartApp.view.DashBoardView.POrderStatusChart.POrderStatusChartController",
    {
        ...
        init: function () {
            ...
            var text =
                ...
                Ext.Date.format(fromDate, "d/m/y") +
                " đến " +
                Ext.Date.format(toDate, "d/m/y");
            var captions = {
                // title: {
        ...
        onBtnRefresh: function () {
            ...
            var POrderStatusChartStore = viewModel.getStore(
        ...
        onBtnChangeView: function () {
            ...
            // var mainView = Ext.getCmp('DashBoardMainView');
            // if(mainView) mainView.setLoading(true);
            var isPOrderStatusChart_Grid_Show = viewModel.get(
                "isPOrderStatusChart_Grid_Show"
            );
            viewModel.set(
                "isPOrderStatusChart_Grid_Show",
                !isPOrderStatusChart_Grid_Show
